...
sealed interface PantryDestination : NavKey {
    ...
    @Serializable
    data object ManageCategories : PantryDestination

    @Serializable
    data object ManageProducts : PantryDestination

    @Serializable
    data object PantryInfo : PantryDestination

    @Serializable
    data object Login : PantryDestination

    @Serializable
    data object Register : PantryDestination
